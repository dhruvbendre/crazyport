...
# Category prompts for the empty state. Abstract until Round 2 supplies real
# questions worth asking; then replace these with the strongest five.
CATEGORIES: list[tuple[str, str]] = [
    ("Story", "Who is Dhruv Bendre?"),
    ("Experience", "What is Dhruv's professional background?"),
    ("Projects", "What has Dhruv worked on?"),
    ("Research", "What research has Dhruv published?"),
    ("Skills", "What technologies does Dhruv work with?"),
]

settings = load_settings()

st.set_page_config(
    page_title=f"{settings.archive_name} · Ask the archive about {settings.owner_short}",
    page_icon=None,
    layout="centered",
