...
/**
 * Verdance · My story · "How did he get here?"
 * (Swapped with Magnara on 2026-09-07: Verdance carries the story, Magnara the projects.)
...
export const verdance: FestivalContent = {
  ...
  ticker: ["Verdance", "My story", "How I got here", "Since 2005 · Mumbai"],
  lockup: { name: "verdance", sub: "my story" },
  nav: {
    links: [
  ...
  board: {
    ...
    story: [
      "Verdance is the green and blue world, the one with a satellite. Read it top to bottom and you are reading Dhruv's story as it grew.",
      ...
      "It is still growing. The next chapter is being written right now, one shipped project at a time."
    ],
    stats: [
    ...
    form: {
      kind: "mail",
      to: MAIL_TO,
      subject: "Verdance: a question about the story",
      submit: "Send",
      fields: [
  ...
  cards: [
    ...
    },
    {
      ...
      button: { label: "View projects", href: "/magnara#stages" },
      tabs: [
  ...
  footer: { big: ["Verdance", "is growing"], logo: ["Verd", "ance"], sub: "my story" }
};
