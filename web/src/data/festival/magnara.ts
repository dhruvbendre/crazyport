...
/**
 * Photos come from the Framer portfolio's work pages (dhruvsportfoliob.framer.website/work/…),
 * saved as WebP in public/festival/magnara/photos/ (2026-09-07).
...
export const magnara: FestivalContent = {
  ...
  ticker: ["Magnara", "Projects & research", "3 live projects", "1 published paper"],
  lockup: { name: "magnara", sub: "projects & research" },
  nav: {
    links: [
  ...
  board: {
    ...
    story: [
      "Magnara is the great banded world. Each band is something Dhruv built: an idea turned into a thing people can actually use.",
      ...
      "Underneath the bands runs the research: real-time sign language recognition, published and shipped. Every project on this world is proof that he finishes."
    ],
    stats: [
    ...
    form: {
      kind: "mail",
      to: MAIL_TO,
      subject: "Magnara: a project idea",
      submit: "Send",
      fields: [
  ...
  cards: [
    {
      ...
      photo: { src: "/festival/magnara/photos/snapclass.webp", alt: "SnapClass cover art", caption: "SnapClass · AI-powered attendance through facial recognition and voice authentication, live on Streamlit" },
      tabs: [
    ...
    },
    {
      ...
      meta: ["Jul 2026 · 3 to 4 weeks", "LangChain · Groq Llama 3.3 70B · Tavily"],
      button: { label: "View project", href: LIVE.research },
      photo: { src: "/festival/magnara/photos/research-system.webp", alt: "Multi-Agent Research System cover art", caption: "Multi-Agent Research System · a Search, Reader, Writer and Critic agent turn a question into a scored research report" },
      tabs: [
    ...
    },
    {
      ...
      meta: ["Jun 2026 · 1 week", "Get Set Learn · Streamlit · Supabase · RAG · Agno"],
      button: { label: "View project", href: LIVE.hackathon },
      photo: { src: "/festival/magnara/photos/hackathon.webp", alt: "STEM Hackathon platform header", caption: "Hackathon Management Platform · discover, register, pay and get receipts, with a RAG assistant that answers the rules · built in one week for Get Set Learn" },
      tabs: [
    ...
    {
      lockup: ["My", "ChessBot"],
      meta: ["Sep 2024 → ongoing", "Stockfish · PGN · Streamlit"],
      button: { label: "View source", href: LIVE.chessbot },
      photo: { src: "/festival/magnara/photos/chessbot.webp", alt: "Dhruv's Chess Bot cover art", caption: "MyChessBot · learns my playing style from my own PGN games and plays it through Stockfish · interface redesign in progress" },
      tabs: [
    ...
    },
    {
      ...
      meta: ["Mar 2026 · Zenodo · DOI 10.5281/zenodo.20352667", "WebRTC · MediaPipe · CVZone · Random Forest"],
      button: { label: "Read research", href: LIVE.paper },
      photo: { src: "/festival/magnara/photos/sign-language.webp", alt: "Pipeline of the sign language support system", fit: "contain", caption: "Published research · real-time sign language support on video calls: hand landmarks to text and speech at 98.2% accuracy" },
      tabs: [
  ...
  footer: { big: ["Magnara", "is long"], logo: ["Mag", "nara"], sub: "projects & research" }
};
